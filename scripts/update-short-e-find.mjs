...
async function run() {
  ...
  try {
    ...
    console.log("Updating skill node 'ukg-eng-short-e-find' in 'skills_v2'...");
    const skillNodeUpdate = await db.collection('skills_v2').updateOne(
      { id: 'ukg-eng-short-e-find' },
      { 
        $set: { 
          engine: 'dynamic_pool',
          templateId: 'ukg-short-e-find',
    ...
    const questionDoc = {
      id: 'english_ukg-english-reading-foundations_ukg-eng-short-e-find_dynamic',
      skillId: 'ukg-eng-short-e-find',
      subject: 'english',
      topic: 'ukg-english-reading-foundations',
      grade: 'ukg',
      type: 'dynamic_pool',
      interaction: 'image_pick',
      questionText: 'Listen to each word. Which word has the short e sound?',
      voice: 'Puck',
    ...
    console.log(`\n========================================`);
    console.log(`✅ Success: Configured Option Pooling for 'ukg-eng-short-e-find'.`);
    ...
    console.log(`\n🔗 Test practice link:`);
    console.log(`👉 http://localhost:3000/practice?subject=english&topic=ukg-english-reading-foundations&skill=ukg-eng-short-e-find`);
    console.log(`========================================\n`);
